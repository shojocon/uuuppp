...
function showHitokoto(){
    $.post("https://sakurasj.com/api/hitokoto/",function(result){
        showMessage(result);
    });
}
...
jQuery(document).ready(function($){
    $("#spig").mousedown(function(e){
        if(e.which==3){showMessage("秘密通道:<br />    <a href=\"https://sakurasj.com\" title=\"首页\">首页</a>        <a href=\"/wp-admin/\" title=\"后台\">后台</a> ",10000);}
    });
